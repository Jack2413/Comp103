...
public class GeneralTreeNode {
    ...
    public GeneralTreeNode findNode(String targetName) {
        ...
        if(this.getName().equals(targetName)) return this;
            ...
            for(GeneralTreeNode child : children){
                GeneralTreeNode target = child.findNode(targetName);
     ...
     */
    public void remove() {
        GeneralTreeNode donorNode=this;
        this.parent.addChildrenFromNode(donorNode);
    ...
    public void addChildrenFromNode(GeneralTreeNode donorNode) {
        for(GeneralTreeNode child : donorNode.getChildren()){
            this.getChildren().add(child);

        }
        donorNode.children=new HashSet<GeneralTreeNode>();
    ...
    public void printSubtree() {
        ...
        for ( GeneralTreeNode child : children) child.printSubtree();
    ...
    public void printPathToRoot() {
        UI.println(this.getName());
        if(this.parent!=null)this.parent.printPathToRoot();
    ...
    public void redrawSubtree() {
        ...
        this.redrawNode();
        for ( GeneralTreeNode child : children){
            double childX = child.location.getX();
            double childY = child.location.getY();
            UI.drawLine(currentX,currentY,childX,childY);
            child.redrawSubtree();
        }
    }
