...
public class Images implements Iterable<String>
{
    ...
    public void reverseImages() {
        if(head!=null){
            ...
            ImageNode newcursor = cursor;
            while(head.nodeBefore(cursor)!=null){
                newcursor.setNext(head.nodeBefore(cursor));
                moveCursorLeft();
            ...
            while (newhead.getNext()!= null) {
                cursor.setNext(newhead.getNext());
                moveCursorRight();
